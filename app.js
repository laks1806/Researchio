var express 		= require("express"),
    ...
    serviceAccount  = require("./researchioKey.json"),
...
mongoose.connect("mongodb+srv://laksisha:lakshitaisha2020@cluster0.nv5kh.mongodb.net/RESEARCHIO?retryWrites=true&w=majority", { useNewUrlParser: true });

//connect to firebase
admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  storageBucket: "gs://researchio-9bfa7.appspot.com/"
});
